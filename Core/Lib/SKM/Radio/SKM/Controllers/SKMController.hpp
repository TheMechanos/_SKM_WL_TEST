...
public:
	typedef std::function<void(SKMPacket* packet)> Callback;
	...
	virtual void progressPacket(SKMPacket* packet);

	void onRx(Callback onRxFunction){
		this->onRxFunction = onRxFunction;
	}

...
SKMRadioSX126X::SKMRadioSX126X(SKM_SX1662_Interface* interface, SX126xConfig* config) :
		SX126x(interface, config){
...
void SKMRadioSX126X::onIrqTxCpltCallback(){
...
void SKMRadioSX126X::onIrqRxCpltCallback(){
	isReceiving = false;
	/*if(mode == Mode::ContRx){
...
void SKMRadioSX126X::onIrqPreambleDetectedCallback(){
	isReceiving = true;
}

void SKMRadioSX126X::onIrqSyncWordValidCallback(){

}

void SKMRadioSX126X::onIrqCRCErrorCallback(){
	isReceiving = false;
	listner->onTxRxFail();
}

void SKMRadioSX126X::onIrqRxTxTimeoutCallback(){
	isReceiving = false;
	listner->onTxRxFail();
}

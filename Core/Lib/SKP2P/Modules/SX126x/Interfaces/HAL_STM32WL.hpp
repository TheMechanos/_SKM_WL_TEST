...
namespace SKP2P{
	...
	class SX126x_STM32WL_HAL_Interface : public SX126x_Interface {
	public:
		...
		SX126x_STM32WL_HAL_Interface() = default;
		SX126x_STM32WL_HAL_Interface(BaudRatePrescaller prescaller, uint32_t priority, PIN* txPin, PIN* rxPin){

...
#ifndef SRC_RADIOINTERFACE_HPP_
#define SRC_RADIOINTERFACE_HPP_

#include <Modules/SX1262/SKM_SX1262_Interface.hpp>
...
class RadioInterface : public SKM_SX1662_Interface {
public:
	...
	RadioInterface(BaudRatePrescaller prescaller, uint32_t priority, PIN* txPin, PIN* rxPin){
